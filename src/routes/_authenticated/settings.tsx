          ...
          <nav className="flex space-x-2 lg:flex-col lg:space-x-0 lg:space-y-1">
            {sidebarNavItems.map((item) => (
              <Link
                key={item.href}
                to={item.href}
                className="justify-start text-sm font-medium transition-colors hover:text-primary flex items-center gap-2 px-4 py-2 rounded-md text-muted-foreground hover:bg-muted/50"
                activeProps={{
